...
//    ready = false;
  ...
  ext.controlLED = function(val) {
    ...
    if (val == 'on') {
      //
      let value;
      value = Uint8Array.of(0x01,0x04,0x08,0x00,0x02,0x07,0x01,0x00,0x00,0x01,0x08,0x06,0x00,0x00,0x00,0x01,0x01,0x07,0x01,0x01);
      ...
      //LED ON
      setTimeout(function() {
        value = Uint8Array.of(0x00,0x01,0x02,0x00,0x05,0x03,0x02,0x00,0x00,0x80,0x00,0x08,0x02,0x00,0x00,0x01,0x00,0x01,0x01);
        writeCharacteristic.writeValue(value);
        setTimeout(function() {
